...
/**
 * Strings for component 'qtype_coderunner', language 'fr', version '4.2'.
 *
...
Le message « Arrêter et lire le feedback final » peut être affiché dès le début, ou seulement une fois que l\'élève ne peut plus améliorer sa note, en raison du régime de pénalités.';
...
La réponse de l\'élève devrait être une fonction C complète, mais elle peut éventuellement
...
La réponse de l\'élève devrait être une fonction C++ complète, mais elle peut éventuellement être précédé d\'un autre code C++ autonome tel que des directives de préprocesseur et fonctions d\'assistance.</p>
...
il n\'y a pas de code par cas de test, et les différents tests utilisent simplement différentes données d\'entrée standard (stdin). On s\'attend à ce que la réponse de l\'élève soit un programme exécutable complet, qui est exécuté tel quel, sans modification par CodeRunner, une fois pour chaque cas de test. Les valeurs du code de test et des champs supplémentaires de chaque
