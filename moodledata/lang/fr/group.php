...
/**
 * Strings for component 'group', language 'fr', version '4.2'.
 *
 * @package     group
 * @category    string
...
$string['participation_help'] = 'Si ce réglage est activé, les membres peuvent sélectionner ce groupe pour les  activités en mode groupes séparés ou groupes visibles. Ce réglage n\'est applicable que si l\'affiliation au groupe es t visible par tout le monde ou seulement visible pour les membres.';
...
$string['visibility_help'] = '* Visible pour tout le monde - tous les participants au cours peuvent voir qui est membre du groupe
...
$string['visibilityall'] = 'Visible pour tout le monde';
