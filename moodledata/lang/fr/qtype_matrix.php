...
/**
 * Strings for component 'qtype_matrix', language 'fr', version '4.2'.
 *
...
<li><b>Kprime</b> : l\'élève reçoit un point, si toutes les réponses sont correctes, un demi-point si une réponse est fausse et que les autres réponses sont correctes, et zéro point sinon.</li>
...
$string['pluginname_help'] = '<p>Les questions Kprime se composent d\'une base d\'item et de quatre propositions de réponse correspondants. Pour chaque proposition de réponse, les élèves doivent décider si elle est bonne ou mauvaise.</p>';
