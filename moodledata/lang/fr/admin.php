...
/**
 * Strings for component 'admin', language 'fr', version '4.2'.
 *
 * @package     admin
 * @category    string
...
$string['debugtemplateinfo_desc'] = 'Si ce réglage est activité, les gabarits utilisés pour le rendu sont affichés en commentaire dans la page HTML. À n\'utiliser que temporairement, à des fins de débogage, car le code HTML résultant produit des erreurs de validation et pourrait rendre certains scripts inopérants.';
...
$string['taskquestionstatscleanupcron'] = 'Ancien nettoyage en tâche de fond des statistiques de question (plus nécessaire)';
