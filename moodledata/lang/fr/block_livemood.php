...
/**
 * Strings for component 'block_livemood', language 'fr', version '4.2'.
 *
...
Une fois enregistré, remplissez le champs ci-dessus avec la clé secrète  de votre organisme que vous avez reçu par mail. Clickez pour enregistrer les modifications et vous êtes prêt à utiliser le bloc d\'extension de Live-Mood (live-school.net). </br>

Chaque professeur et étudiant Moodle sont libres de s\'inscrire / se connecter au block d\'extension Live-Mood (live-school.net) </br>
L\'extension Live-Mood (live-school.net) détecte le rôle pour le cours de l\'utilisateur par défaut. Si un rôle pour le cours n\'est pas définiou si l\'utilisateur est un invité, <br> trois boutons Live-Mood (live-school.net) s\'afficheront (oarganisme, Professeur, Etudiant). <br/><br/>
...
Obtenez la clé sécrète de votre organisme </b> <a href="https://secure.live-school.net/indexOrg.lol" target="_blank">here</a>
</p>';
