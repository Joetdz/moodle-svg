...
/**
 * Strings for component 'format_kickstart', language 'fr', version '4.2'.
 *
...
$string['defaultuserinstructions_desc'] = 'Contenu par défaut affiché aux élèves avant qu\'un modèle ait été choisi par l\'enseignant.';
...
$string['privacy:metadata'] = 'Le plugin au format Kickstart ne stocke aucune donnée personnelle.';
...
$string['userinstructions_help'] = 'Contenu affiché aux élèves avant qu\'un modèle ne soit choisi par l\'enseignant.';
$string['usetemplate'] = 'Utilise le modèle';
